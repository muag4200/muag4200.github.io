...
export var paddleSound = new soundFile("pongSound3.mp3");
soundArray.push(paddleSound);
paddleSound.player.volume.value = -25;

export var scoreSound = new soundFile("phaserDown2.mp3");
soundArray.push(scoreSound);

export var ambientSound = new soundFile("Creepy.mp3");
soundArray.push(ambientSound);
ambientSound.player.loop = true; //turn on looping
ambientSound.player.volume.value = -20; //turn down volume 

export var adventureMusic = new soundFile("Creepy.mp3");
soundArray.push(adventureMusic);
adventureMusic.player.loop = true;
adventureMusic.player.volume.value = -16;

export var villageMusic = new soundFile("Creepy.mp3");
